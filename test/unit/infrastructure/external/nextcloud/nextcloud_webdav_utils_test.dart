...
void main() {
  group('NextcloudWebdavUtils', () {
    ...
    test(
      'parseCollectionNamesFromPropfind deve retornar apenas pastas filhas',
      () {
        const xmlStr = '''
<?xml version="1.0"?>
...
''';
  ...
  group('NextcloudDestinationConfig', () {
    test(
      'toJson/fromJson deve manter valores (incluindo segredo criptografado)',
      () {
        ...
        expect(
          restored.allowInvalidCertificates,
