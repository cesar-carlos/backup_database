...
Guia operacional para incluir mais um motor de banco no produto com o
...
| 4 | **DI** | Registrar no fluxo central `registerBackupDatabaseDefaultSgbds`. Quando o helper `getIt.registerSgbd<...>(...)` cobrir o caso, use-o; quando nao cobrir, siga o mesmo padrao de registro explicito usado pelos SGBDs atuais. Ver `lib/core/di/sgbd_registration.dart`. |
...
- [ ] Registro DI segue o mesmo padrao centralizado dos SGBDs atuais em `registerBackupDatabaseDefaultSgbds`.
