...
| [ADR-016](016-licensing-audit-secret-handling-and-revocation.md) | Audit de licenciamento — secret handling, anti-rollback de CRL e UX de status | accepted | 2026-05-28 |
